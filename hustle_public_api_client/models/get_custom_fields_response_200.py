...
T = TypeVar("T", bound="GetCustomFieldsResponse200")


@_attrs_define
class GetCustomFieldsResponse200:
    """
    Attributes:
        items (List['CustomField']): List of custom fields that match the specified filter.
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for items_item_data in _items:
            items_item = CustomField.from_dict(items_item_data)
        ...
        get_custom_fields_response_200 = cls(
            items=items,
            cursor=cursor,
            has_more=has_more,
        )

        return get_custom_fields_response_200
