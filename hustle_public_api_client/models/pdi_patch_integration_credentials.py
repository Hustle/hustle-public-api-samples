...
T = TypeVar("T", bound="PDIPatchIntegrationCredentials")


@_attrs_define
class PDIPatchIntegrationCredentials:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        pdi_patch_integration_credentials = cls(
            username=username,
            password=password,
            api_key=api_key,
        )

        return pdi_patch_integration_credentials
